...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/parsley-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/parsley-feedstock)
...
Once the `conda-forge` channel has been enabled, `parsley` can be installed with:

```
conda install parsley
```

It is possible to list all of the versions of `parsley` available on your platform with:
